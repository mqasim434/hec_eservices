...
class MyBottomSheet {
  ...
  Future<int> showSearchableBottomSheet(
    ...
    List sortedData = Controller.text.isNotEmpty
        ? data.where((e) => e.toString().contains(Controller.text)).toList()
        : data;
  ...
  showSnackbar(
    ...
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        ...
        content: Text(
          msg,
          style: TextStyle(
              color: type == SnackBarType.Alert ? Colors.black : Colors.white),
        )));
  }

  Future<int> showImageSelectorBottomSheet(
    BuildContext context,
  ) async {
    int selectedIndex = 0;
    await showModalBottomSheet(
...
enum SnackBarType { Danger, Success, Alert }
