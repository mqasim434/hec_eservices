      ...
      body: Scaffold(
        ...
        body: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                Toffee2(Title: "Account Setting", svg: "assets/accountSetting.svg", onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context){return AccountSetting();}));
                },type: ToffeeType.setting),
                Toffee2(Title: "Change Password", svg: "assets/changePassword.svg", onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context){return ChangePassword();}));
                },type: ToffeeType.setting),
                Toffee2(Title: "Log Out", svg: "assets/logOut.svg", onPressed: (){
